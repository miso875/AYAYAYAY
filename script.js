document.addEventListener('DOMContentLoaded', () => {
    ...
    function startCardLoader() {
        ...
        function animateLoader(timestamp) {
            ...
            if (progress < 1) {
                ...
                isReady = true;
                triggerOverlay.classList.add('ready');
            }
        }
    ...
    triggerOverlay.addEventListener('click', () => {
        if (!isReady) return;   // ignore taps while the loader is still running
        isReady = false;        // prevent double-triggering
